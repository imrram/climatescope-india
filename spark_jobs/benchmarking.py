...
# Set your target variable here (e.g. temperature or precipitation)
TARGET_VARIABLE = "APCP_sfc"  # Change this if needed
...
# Convert string timestamp to Spark TimestampType
